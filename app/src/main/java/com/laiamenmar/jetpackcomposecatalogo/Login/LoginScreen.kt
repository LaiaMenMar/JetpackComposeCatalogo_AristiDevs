package com.laiamenmar.jetpackcomposecatalogo.Login
...
fun ForgotPassword(modifier: Modifier) {
    /*Text(text = "Forgot password?", fontSize = 12, fontWeight = FontWeight.Bold, color = Color(0xFF4EA8E9))*/
    Text(
...
fun Password(password: String, onTextChanged: (String) -> Unit) {
    ...
    TextField(
        ...
        Modifier.fillMaxWidth(), placeholder = { Text(text = "Password") },
        maxLines = 1,
        singleLine = true,
