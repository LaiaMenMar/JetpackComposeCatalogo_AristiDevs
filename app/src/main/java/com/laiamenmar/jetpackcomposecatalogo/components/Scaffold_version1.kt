    ...
    ModalNavigationDrawer(
        ...
        content = {
            Scaffold(
                ...
                bottomBar = { MyBottomNavigation_v1() },
                floatingActionButton = { MyFAB_v1() }, // En MD3, el FAB ya no se puede anclar (dock) a la NavigationBar
...
@Composable
fun MyTopAppBar_v1(onClickIcon: (String) -> Unit, onClickDrawer: () -> Unit) {
    TopAppBar(
